...
From `liquid_tags.notebook` (last 2 cells omitted):

{% notebook 20151030_test/20151030_test.ipynb cells[:-2] %}
...
<!-- Note: Do not prettify (e.g. with JS Beautify) the "basic" HTML export, otherwise it will not render correctly. -->
